 ...
 * When the MyProgressMonitor is created it is given a numeric range and a
 ...
 */
public class MyProgressMonitor extends Object implements Accessible
{
    private MyProgressMonitor root;
     ...
     * @see JOptionPane
     */
    public MyProgressMonitor(Component parentComponent,
                             Object message,
                             String note,
                             int min,
                             int max) {
    ...
    private MyProgressMonitor(Component parentComponent,
                              Object message,
                              String note,
                              int min,
                              int max,
                              MyProgressMonitor group) {
        this.min = min;
        this.max = max;
    ...
    private class ProgressOptionPane extends JOptionPane
    {
        ProgressOptionPane(Object messageList) {
            super(messageList,
                  ...
                  null,
                  MyProgressMonitor.this.cancelOption,
                  null);
        }
        ...
        public AccessibleContext getAccessibleContext() {
            return MyProgressMonitor.this.getAccessibleContext();
        }
    ...
    /**
     * The <code>AccessibleContext</code> for the <code>MyProgressMonitor</code>
     * @since 1.5
     */
    ...
    public AccessibleContext getAccessibleContext() {
        ...
        if (pane != null && accessibleJOptionPane == null) {
            ...
            // the MyProgressMonitor does not have a Component
     ...
     * support for the <code>MyProgressMonitor</code> class.
     * @since 1.5
     */
    protected class AccessibleProgressMonitor extends AccessibleContext
        ...
        /*
         * The accessibility hierarchy for MyProgressMonitor is a flattened
         ...
         * has been created. Because the MyProgressMonitor is not a Component
